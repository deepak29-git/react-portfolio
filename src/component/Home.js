...
function Home(){
    ...
    return(
        <div >
            ...
            <h1 >Deepak Goyal the <span className='page-title'>web developer</span></h1>
            ...
            <a className="primary-btn none" href="https://drive.google.com/file/d/1Jy337LgLdPKQVr-zUZd5VcBHEQuEUxoU/view?usp=sharing">Download Resume</a>
            </div>
